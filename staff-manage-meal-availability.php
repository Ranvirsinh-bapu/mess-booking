                ...
                <div class="card card-dashboard text-white bg-success">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <small><?php echo round(($used_capacity / max($mess_daily_capacity, 1)) * 100, 1); ?>%
                                utilized</small>
                        </div>
                ...
                <div class="card card-dashboard limits-card">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo htmlspecialchars($daily_limits['max_bookings_per_user']); ?>
                            </h2>
                    ...
                    <div class="card card-dashboard meal-card <?php echo $card_classes[$index]; ?>">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span
                                    class="badge <?php echo $meal_availability[$meal_type] ? 'bg-success' : 'bg-danger'; ?>">
                            ...
                            <div class="row text-center">
                                <div class="col-6">
                                    ...
                                    <div class="fw-bold">
                                        <?php echo date('H:i', strtotime($limits['start_time'])) . '-' . date('H:i', strtotime($limits['end_time'])); ?>
                                    </div>
                                </div>
                                <div class="col-6">
                    ...
                    <?php foreach ($meal_types_to_manage as $meal_type): ?>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <i
                                    class="<?php echo ['fas fa-coffee', 'fas fa-utensils', 'fas fa-moon'][array_search($meal_type, $meal_types_to_manage)]; ?> me-3 text-muted"></i>
                            ...
                            <form action="staff-manage-meal-availability.php" method="post"
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox"
                                        id="toggle-<?php echo htmlspecialchars($meal_type); ?>" name="is_available"
                                        value="1" <?php echo $meal_availability[$meal_type] ? 'checked' : ''; ?>
                                        onchange="this.form.submit()">
                                    <label class="form-check-label"
                                        for="toggle-<?php echo htmlspecialchars($meal_type); ?>">
                                        <?php echo $meal_availability[$meal_type] ? 'Available' : 'Unavailable'; ?>
                                    </label>
                                </div>
                            </form>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="staff-manage-meal-availability.php" method="post">
                                        ...
                                        <input type="hidden" name="meal_type"
                                            value="<?php echo htmlspecialchars($meal_type); ?>">
                                    ...
                                    <form action="staff-manage-meal-availability.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="cutoff_hours"
                                                value="<?php echo htmlspecialchars($limits['cutoff_hours']); ?>" min="0"
                                                max="24" required>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" name="max_bookings_per_user"
                                value="<?php echo htmlspecialchars($daily_limits['max_bookings_per_user']); ?>" min="1"
                                max="10" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" name="max_total_persons"
                                value="<?php echo htmlspecialchars($daily_limits['max_total_persons']); ?>" min="1"
                                max="<?php echo $mess_daily_capacity * 2; ?>" required>
